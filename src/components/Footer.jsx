...
function Footer() {
  return (
    <>
    <section className='bg-slate-200 w-full md:px-20 px-10 md:py-20 py-10 flex
    flex-col justify-center items-center gap-6 border-[20px] border-gray-400'>
      <h1 className='text-black font-bold text-5xl'>Barber <span className='italic
      text-gray-400'>Shop</span></h1>
      <p className='text-lg text-center font-semibold text-slate-600'>Lorem ipsum dolor
